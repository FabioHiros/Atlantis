...
export default class MenuPrincipal implements Menu {
    mostrar(): void {
        ...
        console.log(`----------------------`)
        console.log(`| 5 - Cadastrar acomodações`)
        console.log(`| 6 - Listar acomodações`)
        console.log(`| 7 - Editar acomodações`)
        console.log(`| 8 - Excluir acomodações`)
        console.log(`| 9 - Listar Estadias`)
        console.log(`| 10 - Cadastrar Estadias`)
        console.log(`| 11 - Editar Estadias`)
        console.log(`| 12 - Excluir Estadias`)
        console.log(`----------------------`)
        console.log(`****************************`)
        console.log(`| 0 - Sair`)
        console.log(`----------------------`)
